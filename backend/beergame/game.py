...
def combine_weekly(D):
    """combine a dictionary with weekly vxalues into a single list"""
    if len(D) > 1:
...
class Game(object):
    ...
    def __init__(self,config):
        ...
        # set default values
        self.auto_order_method = 'WSG'  # auto order method: XSG or WSG
        self.quick_backorder_recovery = True  # auto order method parameter: True or False
    ...
    def update_mongodb(self):
        game_data = {
            ...
            'kpi_customer_satisfaction': self.kpi_customer_satisfaction,
            'kpi_green_score': self.kpi_green_score,
