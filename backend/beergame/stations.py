...
class Station():
    ...
    def save_to_firebase(self):
        ...
        station_data.update({
            ...
            'received_po': self.received_po,
            'sent_po': self.sent_po,
            'inbound': self.inbound,
            'outbound': self.outbound,
            'kpi_weeklycost_inventory': self.kpi_weeklycost_inventory,
            'kpi_weeklycost_backorder': self.kpi_weeklycost_backorder,
            'kpi_weeklycost_transport': self.kpi_weeklycost_transport,
            'kpi_total_cost': self.kpi_total_cost,
            'kpi_fulfilment_rate': self.kpi_fulfilment_rate,
